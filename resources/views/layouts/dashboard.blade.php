  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Saung Izal</div>
      </a>
      ...
      <li class="nav-item {{ Request::is('admin/costumers*') ? ' active' :  '' }}">
        <a class="nav-link" href="{{ route('admin.costumers.index') }}">
      ...
      <li class="nav-item {{ Request::is('admin/calonCostumers*') ? ' active' :  '' }}">
        <a class="nav-link" href="{{ route('admin.calonCostumers.index') }}">
          <i class="fas fa-users"></i>
          <span>CALON COSTUMERS</span>
        </a>
      </li>

      <li class="nav-item {{ Request::is('admin/agens*') ? ' active' :  '' }}">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Hak Cipta Dilindungi &copy; 2020 Developed By Faisal Dwiki Amrizal </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="#" style="cursor: pointer"
